...
int main(){
    ...
    ifstream fin("Datahazard.txt");     //No.2 input
    ofstream fout("dataResult.txt");    //No.2 output
        ...
        if(i>=1){                   //decoder for ID/EX
            if(a[i-1]==inszero){
                ...
                if(opcode[i-1]==rtype){     //judge if the R type
                    ...
                    else if(opcode[i-1]==sw){
                        control9="000100100";
                    }
                    else if(opcode[i-1]==bne){
                        control9="001010000";
                    }
                    else if(opcode[i-1]==addi){
                        control9="000100010";
                    }
                    else if(opcode[i-1]==andi){
                        control9="011100010";
                    }
                }
            }
